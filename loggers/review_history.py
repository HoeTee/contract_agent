...
def load_history_records(data_dir: Path, username: str) -> list[dict]:
...
def save_history_records(data_dir: Path, username: str, records: list[dict]) -> None:
    path = history_file_path(data_dir, username)
...
def append_history_record(data_dir: Path, username: str, record: dict) -> None:

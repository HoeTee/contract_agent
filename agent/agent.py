...
class Agent:
    ...
    async def log_conversation(self):
        """Log conversation to JSON file in logger/conversation_logs/."""
        log_dir = os.path.join(PROJECT_ROOT, "logger", "conversation_logs")
        ...
        filepath = os.path.join(log_dir, f"{self.name}_{ts}.json")
        try:

...
```powershell
python scripts\docxindex\experiments\table_mapping\cli.py
```
...
```powershell
python scripts\docxindex\experiments\table_mapping\cli.py "合同.docx" --table-block 225 --out outputs\table_mapping_test --write-mode copy
```

...
class BuildIndexTest(unittest.TestCase):
    def test_build_uses_retrieval_cli_and_propagates_no_cache(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_dir:
            ...
            with patch("docxindex_eval.runner._run_retrieval_cli", return_value=(payload, "", 1.25)) as run_cli:
    ...
    def test_ask_uses_same_retrieval_config(self) -> None:
        ...
        payload = {"nodes": []}
        with patch("docxindex_eval.runner._run_retrieval_cli", return_value=(payload, "", 0.5)) as run_cli:

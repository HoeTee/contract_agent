...
DOCXINDEX_ROOT = PROJECT_DIR.parent
REPO_ROOT = DOCXINDEX_ROOT.parents[1]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate the docxindex Gold CSV from complete contract text.")
